	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active"><?php 
				$p = mysqli_fetch_array(mysqli_query($conn,"Select * from alat where id='$id'"));
				echo $p['namaalat'];
				?></li>
			</ol>
		</div>
		...
		<div class="container">
			<div class="agileinfo_single">
				...
				<div class="col-md-4 agileinfo_single_left">
					<img id="example" src="<?php echo $p['gambar']?>" alt=" " width="200px" height="200px">
				</div>
				<div class="col-md-8 agileinfo_single_right">
				<h2><?php echo $p['namaalat'] ?></h2>
