		...
		<div class="container">
			...
			<div class="agile-login">
				...
				if(!isset($_SESSION['log'])){
					...
					<ul><a href="admin">Input Data</a></ul>
					<li><a href="logout.php">Keluar?</a></li>
					';
					};
			...
			<div class="product_list_header">  
					<a href="#"><button class="w3view-cart" type="submit" name="submit" value=""><img src="images/bmkglogo.png" alt=" " class="img-responsive" /></button>
					 </a>
			</div>
			<!--bmkglogo header-->
		...
		<div class="container">
			...
			<div class="login-form-grids">
				...
				<form method="post">
					...
					<input type="text" name="alamat" placeholder="Nama Stasiun" required>
			...
			<p><a href="login.php">Masuk Sekarang</a></p>
		</div>
