		...
		{	
			header('location:login.php');
				...
				if($liat>0){
							...
							//cek barang serupa
							$cekbrg = mysqli_query($conn,"select * from detailorder where idalat='$idalat' and orderid='$orid'");
							...
							if($liatlg>0){
								...
								$updateaja = mysqli_query($conn,"update detailorder set qty='$baru' where orderid='$orid' and idalat='$id'");
								
								if($updateaja){
									echo " <div class='alert alert-success'>
								Barang sudah pernah dimasukkan ke keranjang, jumlah akan ditambahkan
							  </div>
							  <meta http-equiv='refresh' content='1; url= alat.php?idalat=".$idalat."'/>";
								} else {
							...
							$tambahdata = mysqli_query($conn,"insert into detailorder (orderid,idalat,qty) values('$orid','$idalat','1')");
							if ($tambahdata){
							echo " <div class='alert alert-success'>
					...
					//kalo belom ada order id nya
						...
						if($bikincart){
							$tambahuser = mysqli_query($conn,"insert into detailorder (orderid,idalat,qty) values('$oi','$idalat','1')");
							if ($tambahuser){
							echo " <div class='alert alert-success'>
								Berhasil menambahkan ke keranjang
							  </div>
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
			...
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">Monitoring Alat BMKG Sorong</a></h1>
			</div>
	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active"><?php 
				$p = mysqli_fetch_array(mysqli_query($conn,"Select * from alat where idalat='$idalat'"));
				echo $p['nama'];
				?></li>
			</ol>
		</div>
	...
	<div class="products">
		<div class="container">
			<div class="agileinfo_single">
				...
				<h3><?php echo $p['namaalat'] ?></h3>
					<div class="w3agile_description"><ul>
						<h4>Kondisi :</h4>
					    <p><?php echo $p['kondisi'] ?></p>
					    <ul>
					...
					<!-- <div class="w3agile_description">
						<h4>Bagian :</h4>
						<p><?php echo $p['namakategori']?></p>
					</div> -->
					<div class="w3agile_description">
					    <h4>Tanggal & Waktu :</h4>
					    <p><?php echo $p['tgldibuat'] ?></p>
					</div>
