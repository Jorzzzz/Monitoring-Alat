...
<html>
<head>
<title>Kategori - Alat BMKG</title>
<!-- for-mobile-apps -->
						...
						<div class="hover14 column">
							<div class="agile_top_brand_left_grid">
								<div class="agile_top_brand_left_grid_pos">
									<img src="images/bmkg.png" alt=" " class="img-responsive" />
								</div>
								<div class="agile_top_brand_left_grid1">
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="alat.php?id=<?php echo $p['idalat'] ?>"><img src="<?php echo $p['gambar']?>" width="200px" height="200px"></a>		
