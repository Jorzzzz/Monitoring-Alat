...
<html>
<head>
<title>BMKG Sorong - Pencarian</title>
<!-- for-mobile-apps -->
	...
	<div class="products">
		<div class="container">
			...
			<div class="col-md-8 products-right">
				...
				<?php 
					$brgs=mysqli_query($conn,"SELECT * from alat where nama like '%$s%' or namaalat like '%$s%' or deskripsi like '%$s%' order by idalat ASC");
									...
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="alat.php?idalat=<?php echo $p['idalat'] ?>"><img src="<?php echo $p['gambar']?>" width="200px" height="200px"></a>		
